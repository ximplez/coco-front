...
export const generatedRoutes: GeneratedRoute[] = [
  ...
  },
  {
    ...
    meta: {
      title: 'coco-manage',
      i18nKey: 'route.coco-manage',
      order: 8
    },
    children: [
      {
        name: 'coco-manage_config-manage',
        path: '/coco-manage/config-manage',
        component: 'view.coco-manage_config-manage',
        meta: {
          title: 'coco-manage_config-manage',
          i18nKey: 'route.coco-manage_config-manage'
        }
      }
    ]
  },
